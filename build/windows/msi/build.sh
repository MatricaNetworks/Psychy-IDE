...
if [[ "${VSCODE_QUALITY}" == "insider" ]]; then
  PRODUCT_NAME="Psychy-IDE - Insiders"
...
if [[ -z "${1}" ]]; then
	OUTPUT_BASE_FILENAME="Psychy-IDE-${VSCODE_ARCH}-${RELEASE_VERSION}"
else
	OUTPUT_BASE_FILENAME="Psychy-IDE-${VSCODE_ARCH}-${1}-${RELEASE_VERSION}"
fi
